...
console.group(`reverseSortedArray: ${reverseSortedArray}`)
...
// 2.94 use square braces to access the first item in the array
const firstItem = scaledArray[0]
console.log(`scaledArray[0]: ${scaledArray[0]}`)

// 2.95 use square braces to access the second item in the array
const secondItem = scaledArray[1]
console.log(`scaledArray[1]: ${scaledArray[1]}`)

// 2.96 use square braces to access the last item in the array

const lastItem = scaledArray[scaledArray.length - 1]
